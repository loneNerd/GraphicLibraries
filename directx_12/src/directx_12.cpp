...
void DirectX12::init()
{
    ...
    m_window->init();
    m_window->setTitle(L"DirectX 12");
...
void DirectX12::initPipeline()
{
    ...
    throwIfFailed(D3DCompileFromFile(getFileFullPath(L"shaders\\vertex.hlsl").c_str(), nullptr, nullptr,
        "main", "vs_5_0", compileFlags, 0, &vertexBlob, nullptr),
        "Can't compile vertex shader from file");

    throwIfFailed(D3DCompileFromFile(getFileFullPath(L"shaders\\pixel.hlsl").c_str(), nullptr, nullptr,
