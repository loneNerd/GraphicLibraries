...
void DirectX11::initPipeline()
{
    ...
    throwIfFailed(D3DCompileFromFile(getFileFullPath(L"directx11\\shaders\\vertex.glsl").c_str(),
                                     nullptr, nullptr,
                                     "main", "vs_4_0", 0, 0,
    ...
    throwIfFailed(D3DCompileFromFile(getFileFullPath(L"directx11\\shaders\\pixel.glsl").c_str(),
                                     nullptr, nullptr,
