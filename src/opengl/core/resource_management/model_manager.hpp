...
#include "opengl/resources/parsers/assimp_parser.hpp"
...
namespace ResourceManagement
{
    ...
    public:
        ...
        virtual std::shared_ptr<OpenGL::Resources::Model> Create(std::filesystem::path filePath, OpenGL::Resources::Parsers::EModelParserFlags parserFlags = OpenGL::Resources::Parsers::EModelParserFlags::None);
        virtual void Reload(std::shared_ptr<OpenGL::Resources::Model> model, std::filesystem::path filePath, OpenGL::Resources::Parsers::EModelParserFlags parserFlags = OpenGL::Resources::Parsers::EModelParserFlags::None);
