#pragma once
#ifndef GRAPHIC_LIBRARIES_OPENGL_OBJECTS_TEXTURE_HPP_
#define GRAPHIC_LIBRARIES_OPENGL_OBJECTS_TEXTURE_HPP_
...
namespace Objects
{
    ...
    class Texture : public Interfaces::IResource
    {
    public:
        Texture();
        ~Texture();
...
#endif // GRAPHIC_LIBRARIES_OPENGL_OBJECTS_TEXTURE_HPP_
