#pragma once
#ifndef ENGINE_OPENGL_OPENGL_RENDERER_HPP_
#define ENGINE_OPENGL_OPENGL_RENDERER_HPP_
...
namespace OpenGL
{
    ...
    {
    public:
        OpenGLRenderer(std::shared_ptr<Driver> driver) : m_driver(driver) { }
...
#endif // ENGINE_OPENGL_OPENGL_RENDERER_HPP_
