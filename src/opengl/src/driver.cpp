...
OpenGL::Driver::Driver(bool debug)
{
    initGlew();
...
void OpenGL::Driver::GLDebugMessageCallback(uint32_t source, uint32_t type, uint32_t id, uint32_t severity, int32_t length, const char* message, const void* userParam)
{
